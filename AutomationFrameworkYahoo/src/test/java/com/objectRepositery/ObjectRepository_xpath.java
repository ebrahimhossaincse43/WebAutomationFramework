...
public class ObjectRepository_xpath {
	...
	public static String yahooMessageCompose = "//a[@data-test-id='compose-button']";
	public static String yahooMessageTo = "//input[@id='message-to-field']";
	public static String yahooMessageSubject = "//input[contains(@data-test-id,'compose-subject')]";
	public static String yahooMessageBody = "//div[@data-test-id='rte']";
	public static String yahooMessageSend = "//button[@data-test-id='compose-send-button']";
